...
public class BucketAndHash implements Serializable {
	 ...
	 *
	 * Only the 64-log2(numberOfBuckets) least significant bits of the resulting
	 * hash are usable
	 */
	public static BucketAndHash fromHash(long hash, int numberOfBuckets) {
		// checkArgument(Numbers.isPowerOf2(numberOfBuckets),
		...
		// hyperloglog will count number of trailing zeros, so fill in with ones
		// at the top to avoid
